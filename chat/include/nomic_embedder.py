...
FIREWORKS_API_KEY = os.getenv("AI21_API_KEY")
BATCH_SIZE = 128
embedding_function = FireworksEmbeddings(api_key=FIREWORKS_API_KEY)
...
def nomic_embed(source_directory: str, target_directory: str) -> None:
    data = []
...
def main():
    ...
    nomic_embed(source_directory, target_directory)
