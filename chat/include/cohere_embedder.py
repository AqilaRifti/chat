...
BATCH_SIZE = 128
embedding_function = embeddings = CohereEmbeddings(
...
def cohere_embed(source_directory: str, target_directory: str) -> None:
    data = []
...
def main():
    source_directory: str = str(sys.argv[1])
    target_directory: str = str(sys.argv[2])
    print(source_directory)
    print(target_directory)
    cohere_embed(source_directory, target_directory)
